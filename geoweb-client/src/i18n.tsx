...
const resources = {
  kk: {
    translation: {
      ...
      aboutUsPage:{
        title:'Біз туралы',
        text:'"Жамбыл облысы Тараз қаласы әкімдігінің тұрғын жай-коммуналдық шаруашылық, жолаушы көлігі және автомобиль жолдары бөлімі" коммуналдық мемлекеттік мекемесі'
      },
  ...
  ru: {
    translation: {
      ...
      aboutUs:{
        title:'О Нас',
        text:`"Коммунальное государственное учреждение "Отдел жилищно-коммунального хозяйства, пассажирского транспорта и автомобильных дорог акимата города Тараз Жамбылской области"`
      },
